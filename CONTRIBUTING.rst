...
dq db manager could always use more documentation, whether as part of the
official dq db manager docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `dq_db_manager` for local development.

1. Fork the `dq_db_manager` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/dq_db_manager.git
